...
from aios.runtime.recovery_alert_escalation import RecoveryAlertEscalationPolicy, RecoveryAlertEscalator
...
def test_persistent_warning_escalates_to_critical() -> None:
    ...
    result = RecoveryAlertEscalator(
        RecoveryAlertEscalationPolicy(30)
...
def test_warning_before_threshold_does_not_escalate() -> None:
    ...
    result = RecoveryAlertEscalator(RecoveryAlertEscalationPolicy(30)).evaluate(
