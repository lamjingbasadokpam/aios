...
class MemoryStore:
    ...
    def remember(self, content: str, *, source: str, namespace: str = "default", metadata: dict | None = None) -> MemoryRecord:
        """Create a memory record while keeping persistence implementation-neutral."""
        record = MemoryRecord(content=content, source=source, namespace=namespace, metadata=metadata or {})
